...
.. code:: json
    ...
    {
        "_href": "http://localhost:8000/pulp/pulp/api/v3/remotes/maven/1/",
        ...
    }
...
sync with. You are telling pulp to fetch content from the remote and add to the repository::
    ...
    $ http POST $BASE_ADDR/pulp/pulp/api/v3/remotes/maven/1/sync/' repository=http://localhost:8000/pulp/api/v3/repositories/1/
