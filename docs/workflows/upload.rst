...
Now that Pulp has the content, its time to make it into a unit of content.
    ...
    $ http POST $BASE_ADDR/pulp/api/v3/content/maven/ artifact=http://localhost:24817/pulp/api/v3/artifacts/1/ filename=my_content

Response::

    {
        "_href": "http://localhost:24817/pulp/api/v3/content/maven/1/",
...
$ http POST $REPO_HREF/pulp/api/v3/repositories/1/versions/ add_content_units:="[\"http://localhost:24817/pulp/api/v3/content/maven/1/\"]"
