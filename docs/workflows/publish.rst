...
Publishers contain extra settings for how to publish. You can use a maven publisher on any
repository that contains maven content::

$ http POST $BASE_ADDR/pulp/api/v3/publishers/maven/ name=bar

Response::

    {
        "_href": "http://localhost:24817/pulp/api/v3/repositories/foo/publishers/maven/bar/",
        ...
    }
...
$ http POST $BASE_ADDR/pulp/api/v3/publishers/maven/1/publish/ repository=$BASE_ADDR/pulp/api/v3/repositories/1/
