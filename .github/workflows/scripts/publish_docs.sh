...
mkdir -p ../maven-bindings
tar -xvf maven-python-client-docs.tar --directory ../maven-bindings
pushd ../maven-bindings
...
rsync -avzh site/ doc_builder_pulp_maven@docs.pulpproject.org:/var/www/docs.pulpproject.org/pulp_maven_client/en/"$2"
popd
